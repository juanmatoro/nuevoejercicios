...
- SOAP (Simple Object Access Protocol):
  - Usa XML como formato de intercambio.
  - Más rígido, orientado a servicios empresariales.
  - Se basa en mensajes muy estructurados y complejos.
  - Ejemplo: antiguos servicios bancarios o sistemas corporativos.
- REST (Representational State Transfer):
  - Es el más usado actualmente en web y móviles.
  - Usa URLs y métodos HTTP para acceder a recursos.
  - Los datos suelen enviarse en JSON.
  - Ejemplo: API de Twitter, Google Maps, Spotify.
