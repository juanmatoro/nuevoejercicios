...
Explicación: 
o try: En este bloque se coloca el código que podría generar una excepción. 
El programa intentará ejecutar este código de manera normal. 
o catch: Si se produce una excepción dentro del bloque try, el control se 
...
errores. 
o finally: Es un bloque opcional, y si lo añadimos se ejecutará siempre, se 
